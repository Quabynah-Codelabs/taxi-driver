...
import dev.trotrohailer.shared.util.location.constants.GeoConstants;
...
public abstract class TileSystem {
    ...
    /**
     * Same as {@link #PixelXYToLatLongMapSizeWithoutWrap(int, int, double, LatLng)} (int, int, double, LatLng) PixelXYToLatLong} but without wrap
     */
     ...
     */
    @Deprecated
    public LatLng PixelXYToLatLongMapSize(final int pixelX, final int pixelY,
